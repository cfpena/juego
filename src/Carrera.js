...
Ball.Carrera.prototype = {
	...
	create: function() {
	    ...
	    ship.body.fixedRotation = true;
			...
			/*vida = this.add.sprite(700,1,'vida');
			vida.scale.set(2);
			vida.cropEnabled = true;
			vida.crop.width = (vida / maxvida) * vida.width;
			this.physics.p2.enable(vida, false);*/
	    ...
	    var closeButton = this.make.sprite(pw, -ph, 'close');
